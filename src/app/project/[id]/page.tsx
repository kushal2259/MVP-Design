...
function InteriorTab({ project, interiorData, editedPlans, onPlansChange, layoutOptions, selectedLayoutId }: {
  ...
  const fallbackConcepts = [
    ...
    { room: 'Dining', concept: `An inviting ${req.style} dining space adjoining the kitchen, with a feature pendant over the table and a buffet/crockery unit for storage.`, materials: ['Vitrified Tile Flooring', 'Veneer Accent Wall', 'Solid Wood Table'], colorPalette: ['#FBF7F0', '#5B4636', '#D9A441'], furniturePlan: '6-seater dining table, sideboard/buffet against wall, framed art', lightingConcept: 'Statement pendant over table + dimmable cove for mood' },
    { room: 'Kids Bedroom', concept: `A playful yet practical kids room with study desk, bunk/single bed, and ample storage. Durable, easy-clean finishes and cheerful accents.`, materials: ['Vinyl Plank Flooring', 'Washable Paint', 'Laminate Storage'], colorPalette: ['#FFF7E6', '#4FA3C7', '#F2C14E'], furniturePlan: 'Bed + study desk + open shelving + soft play rug', lightingConcept: 'Bright task light at desk, soft warm night light, fun pendant' },
    { room: 'Guest Bedroom', concept: `A comfortable, neutral guest room that doubles as a flex space. Queen bed, compact wardrobe, and a reading corner.`, materials: ['Engineered Wood', 'Neutral Paint', 'Upholstered Headboard'], colorPalette: ['#F2EEE6', '#8A8170', '#C9B79C'], furniturePlan: 'Queen bed, wardrobe, accent chair + side table', lightingConcept: 'Ambient ceiling + bedside reading lamps' },
    { room: 'Home Office / Study', concept: `A focused ${req.style} work zone with ergonomic desk, acoustic treatment, and shelving. Positioned for good daylight and minimal glare.`, materials: ['Laminate Desk', 'Acoustic Felt Panel', 'Open Shelving'], colorPalette: ['#F5F5F2', '#2F3E46', '#A68A64'], furniturePlan: 'Desk facing window, task chair, bookshelf, pinboard', lightingConcept: 'Glare-free task lamp + indirect ceiling wash' },
    { room: 'Pooja Room', concept: `A serene prayer space (ideally North-East) with a marble/wooden mandir, subtle gold accents, and warm, reverent lighting.`, materials: ['Marble Cladding', 'Carved Wood Mandir', 'Brass Accents'], colorPalette: ['#FFFBF0', '#B8860B', '#7A5230'], furniturePlan: 'Wall-mounted/floor mandir, storage drawer, seating mat', lightingConcept: 'Warm spotlights on deity, hidden cove, diya niche' },
    { room: 'Balcony', concept: `An outdoor lounge with deck flooring, planters, and weatherproof seating — a calm spot for morning chai with cross-ventilation.`, materials: ['WPC Deck Tiles', 'MS Railing + Glass', 'Outdoor Fabric'], colorPalette: ['#EDEae0', '#6B8E23', '#A0522D'], furniturePlan: 'Two lounge chairs + side table, vertical garden, planters', lightingConcept: 'Warm festoon/string lights + wall up-lighter' },
  ];
